...
export class ProductComponent {
  ...
  constructor(private router:Router, public formService: FormService, private staticService: StaticDataService, private rsService:RelationshipService, private opService:OutputService) {}

  ngOnInit() {
    this.staticService.products.pipe(distinctUntilChanged()).subscribe(products => { 
